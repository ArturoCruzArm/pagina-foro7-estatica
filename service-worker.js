...
// Version 3.3.0 - Optimized with WebP support and improved caching

const CACHE_NAME = 'foro7-v3.3.0';
const STATIC_CACHE = 'foro7-static-v3.3.0';
const IMAGE_CACHE = 'foro7-images-v3.3.0';
